...
def print_examples(model, device, dataset):
    ...
    model.eval()
    test_img1 = Image.open("test_examples/dog.jpg")
    display(test_img1)
    ...
    test_img2 = Image.open("test_examples/child.jpg")
    display(test_img2)
    test_img2 = transform(
    ...
    test_img3 = Image.open("test_examples/bus.png")
    display(test_img3)
    ...
    test_img4 = Image.open("test_examples/boat.png")
    display(test_img4)
    test_img4 = transform(
    ...
    test_img5 = Image.open("test_examples/horse.png")
    display(test_img5)
    test_img5 = transform(
